...
seq_root = '/lustre/scratch/client/vinai/users/dungnt244/smartcity/tracking/dataset/MOT15/images/train'
label_root = '/lustre/scratch/client/vinai/users/dungnt244/smartcity/tracking/dataset/MOT15/labels_with_ids/train'

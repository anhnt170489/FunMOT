...
if __name__ == '__main__':
    root = '/lustre/scratch/client/vinai/users/dungnt244/smartcity/tracking/dataset/CrowdHuman/'
    data_val = root + 'images/val'
    label_val = root + 'labels_with_ids/val'
    ann_val = root + 'annotation_val.odgt'
    data_train = root + 'images/train'
    label_train = root + 'labels_with_ids/train'
    ann_train = root + 'annotation_train.odgt'

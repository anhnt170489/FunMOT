...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument("--quant", type=bool)
        self.parser.add_argument("--xmodel")
        ...
        # train
        self.parser.add_argument(
            "--optimizer", type=str, default="ADAM", help="support ADAM, RADAM"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--val_half", action="store_true", help="val haft or full"
        )
        ...
        self.parser.add_argument(
            "--det_only", action="store_true", help="Detection only."
        )
        self.parser.add_argument(
            "--pred_only", action="store_true", help="Prediction only."
        )
        ...
        self.parser.add_argument(
            "--input-video",
            type=str,
            default="/home/ubuntu/workspace/trungdt21/FunMOT/videos/MOT16-03.mp4",
            help="path to the input video",
        )
        self.parser.add_argument(
            "--list-images",
            type=str,
            default="/home/ubuntu/workspace/trungdt21/data_calib_fairmot/LT/images/LiveTrack.train",
            help="path to the input video",
        )
        self.parser.add_argument(
        ...
        # self.parser.add_argument('--data_dir', type=str, default='/lustre/scratch/client/vinai/users/dungnt244/smartcity/tracking/dataset')

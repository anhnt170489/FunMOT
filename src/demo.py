...
if __name__ == '__main__':
    ...
    args = ['mot',
            ...
            '--arch=resfpndcn_18',
            '--conf_thres=0.4',
            '--input-video=/home/namtd/Desktop/lab/eval_track/TNP/AN3.mp4',
            '--output-root=/home/namtd/Desktop/lab/eval_track/TNP/output/AN3',
            '--input_h=320',
            '--input_w=576',
            # '--val_mot17=True',y
            # '--val_mot15=True',
            # '--load_model=../models/mix_half_live_ft_resfpndcn_18_576_320/model_best_2nd.pth']
            '--load_model=../models/deploy_model/silver1.3/model_best.pth']
